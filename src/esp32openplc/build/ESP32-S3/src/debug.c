...
char plc_program_md5[] = "47eeb0d1ce066657f0cf5e6f96bac4ab";
...
static const struct {
    ...
    {&(RES0__INSTANCE0.BLINKTIMER.EN), BOOL_ENUM},
    {&(RES0__INSTANCE0.BLINKTIMER.ENO), BOOL_ENUM},
    {&(RES0__INSTANCE0.BLINKTIMER.IN), BOOL_ENUM},
    {&(RES0__INSTANCE0.BLINKTIMER.PT), TIME_ENUM},
    {&(RES0__INSTANCE0.BLINKTIMER.Q), BOOL_ENUM},
    {&(RES0__INSTANCE0.BLINKTIMER.ET), TIME_ENUM},
    {&(RES0__INSTANCE0.BLINKTIMER.STATE), SINT_ENUM},
    {&(RES0__INSTANCE0.BLINKTIMER.PREV_IN), BOOL_ENUM},
    {&(RES0__INSTANCE0.BLINKTIMER.CURRENT_TIME), TIME_ENUM},
    {&(RES0__INSTANCE0.BLINKTIMER.START_TIME), TIME_ENUM},
    {&(RES0__INSTANCE0.LED_STATE), BOOL_ENUM},
    {&(RES0__INSTANCE0.WS2812_OUT), BOOL_O_ENUM},
};
