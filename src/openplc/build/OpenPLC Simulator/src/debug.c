...
char plc_program_md5[] = "0ae4b45620937540cd7da15400420f1f";
...
static const struct {
    ...
    {&(RES0__INSTANCE0.T1.EN), BOOL_ENUM},
    {&(RES0__INSTANCE0.T1.ENO), BOOL_ENUM},
    {&(RES0__INSTANCE0.T1.IN), BOOL_ENUM},
    {&(RES0__INSTANCE0.T1.PT), TIME_ENUM},
    {&(RES0__INSTANCE0.T1.Q), BOOL_ENUM},
    {&(RES0__INSTANCE0.T1.ET), TIME_ENUM},
    {&(RES0__INSTANCE0.T1.STATE), SINT_ENUM},
    {&(RES0__INSTANCE0.T1.PREV_IN), BOOL_ENUM},
    {&(RES0__INSTANCE0.T1.CURRENT_TIME), TIME_ENUM},
    {&(RES0__INSTANCE0.T1.START_TIME), TIME_ENUM},
    {&(RES0__INSTANCE0.BLINK_STATE), BOOL_ENUM},
    {&(RES0__INSTANCE0.PB1), BOOL_P_ENUM},
    {&(RES0__INSTANCE0.LED), BOOL_O_ENUM},
};
